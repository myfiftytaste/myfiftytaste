...
- Value: 0.13
- Label: 
- Description: Tu notes environ 0,13 étoile(s) au-dessus de la moyenne Letterboxd.
- Confidence: medium
- Data source: 19 films comparables avec moyenne Letterboxd

### Reviewer

- Value: 2/50
- Label: 
- Description: Tu commentes rarement tes films vus.
- Confidence: high
...
- Value: 1h57
- Label: 
- Description: Les films que tu as vus durent en moyenne 1h57.
- Confidence: high
- Data source: 50 films avec durée confirmée

### Chauvin

- Value: USA
- Label: 
- Description: Les États-Unis représentent 61 % des occurrences de pays de production de tes films vus.
- Confidence: high
- Data source: 50 films avec métadonnées confirmées
